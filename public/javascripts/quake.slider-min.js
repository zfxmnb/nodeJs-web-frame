            ...
            return this.each(function() {
                ...
                function animateReversePeal() {
                    ...
                    $(".quake-el").each(function(d) {
                        setTimeout(function() {
                            $(".quake-el:eq(" + c[d] + ")", sliderContainer).fadeIn(animationSpeed / 2,
                            function() {
                                b++;
                                if (b == c.length) {
                                    animationComplete()
                ...
                function addNavigationControls() {
                    ...
                    if (settings.thumbnails) {
                        ...
                        a.append(d);
                        $(".quake-nav-container a").live("mouseenter",
                        function() {
                        ...
                        $(".quake-nav-container a").live("mouseleave",
                        function() {
                            d.css({
                                display: "none",
                                opacity: 0
